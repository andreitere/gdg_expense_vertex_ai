<template>
    <div class="slidev-layout joke grid relative">
      <div class="absolute inset-0 bg-black opacity-80 z-1"></div>
      <div class="flex flex-col justify-center text-center text-white z-2">
        <slot></slot>
      </div>
      <LayoutFooter />
    </div>
  ...
  .slidev-layout.joke {
    ...
    h1 {
      @apply text-6xl leading-20 font-display text-white;
    }
